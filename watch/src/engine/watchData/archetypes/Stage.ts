...
export class Stage extends Archetype {
    ...
    renderLeftDisk() {
        ...
        skin.sprites.turntableBase.draw(new Rect({ l: -8.825 - dw, r: -8.825 + dw, t: 1 - dh, b: 1 + dh }), 3, 1)
        skin.sprites.diskOutside.draw(rotate(origin, new Rect({ l: -8.825 - dw * 0.825, r: -8.825 + dw * 0.825, t: 1 - dh * 0.825, b: 1 + dh * 0.825 }), angle, scaledScreen.wToH * 0.75), 4, 1)
        skin.sprites.diskInside.draw(rotate(origin, new Rect({ l: -8.825 - dw / 3, r: -8.825 + dw / 3, t: 1 - dh / 3, b: 1 + dh / 3 }), angle, scaledScreen.wToH * 0.75), 5, 1)
    }
