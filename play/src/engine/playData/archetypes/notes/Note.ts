...
export abstract class Note extends Archetype {
    ...
    initialize() {
        ...
        new Rect({ l: this.import.lane === -3 ? -11.15 : this.import.lane * 2.1 - 1.05 - 0.25, r: this.import.lane === 3 ? 11.15 : this.import.lane * 2.1 + 1.05 + 0.25, b: 2, t: 0 }).transform(skin.transform).copyTo(this.hitbox)
    }
